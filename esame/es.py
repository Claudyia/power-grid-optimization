...
----------------------
E' una variante di project16.py (stessa cartella), lo script principale
del progetto. La logica e' identica: stessi dati, stesse funzioni,
...
Come si esegue
----------------
    python3 es.py --hours 168 --solver auto
    python3 es.py --check-data          # controlla solo i dati
...
# Cartella dati accanto allo script (vedi project16.py).
DEFAULT_DATA_DIR = SCRIPT_DIR / "Data for projects-20260727"
DEFAULT_OUTPUT_DIR = SCRIPT_DIR / "output_es"
